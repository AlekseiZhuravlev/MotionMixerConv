...
def visualize_ais_data(in_file_name, frame_start, frame_end, frame_step):
    ...
    # print('Visualizing {} frames.'.format(len(pose_data)))
    # return
    for frame in tqdm(pose_data[frame_start:frame_end:frame_step]):
